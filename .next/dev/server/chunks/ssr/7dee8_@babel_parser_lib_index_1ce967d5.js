module.exports = [
"[project]/OneDrive/Desktop/Divine Kitchen/node_modules/@babel/parser/lib/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
            ...
            if (this.input.charCodeAt(this.offsetToSourcePos(commentStart) - 1) === 44) {
                switch(node.type){
                    ...
                    case "ImportExpression":
                        adjustInnerComments(node, [
                            node.source,
                            (_node$options = node.options) != null ? _node$options : null
                        ], commentWS);
                        break;
...
class Node {
    constructor(parser, pos, loc){
        ...
        if ((parser == null ? void 0 : parser.optionFlags) & 128) this.range = [
            pos,
            0
        ];
...
exports.tokTypes = tokTypes; //# sourceMappingURL=index.js.map
}),
];

//# sourceMappingURL=7dee8_%40babel_parser_lib_index_1ce967d5.js.map