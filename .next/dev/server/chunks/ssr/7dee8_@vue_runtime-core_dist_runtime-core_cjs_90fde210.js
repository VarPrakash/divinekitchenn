module.exports = [
"[project]/OneDrive/Desktop/Divine Kitchen/node_modules/@vue/runtime-core/dist/runtime-core.cjs.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var reactivity = __turbopack_context__.r("[project]/OneDrive/Desktop/Divine Kitchen/node_modules/@vue/reactivity/dist/reactivity.cjs.js [app-ssr] (ecmascript)");
...
function setDevtoolsHook$1(hook, target) {
    ...
    // (#4815)
    ("TURBOPACK compile-time value", "undefined") !== "undefined" && // some envs mock window but not fully
    window.HTMLElement && // also exclude jsdom
    // eslint-disable-next-line no-restricted-syntax
    !((_b = (_a = window.navigator) == null ? void 0 : _a.userAgent) == null ? void 0 : _b.includes("jsdom"))) //TURBOPACK unreachable
    ;
    else {
            ...
            if (props) {
                {
                    ...
                    for(const key in props){
                        if (// as it could have mutated the DOM in any possible way
...
function renderList(source, renderItem, cache, index) {
    ...
    if (sourceIsArray || shared.isString(source)) {
        ...
        for(let i = 0, l = source.length; i < l; i++){
            ret[i] = renderItem(needsWrap ? isReadonlySource ? reactivity.toReadonly(reactivity.toReactive(source[i])) : reactivity.toReactive(source[i]) : source[i], i, void 0, cached && cached[i]);
        }
...
function renderComponentRoot(instance) {
    ...
    try {
        if (vnode.shapeFlag & 4) {
            ...
            result = normalizeVNode(render.call(thisProxy, proxyToUse, renderCache, ("TURBOPACK compile-time truthy", 1) ? reactivity.shallowReadonly(props) : "TURBOPACK unreachable", setupState, data, ctx));
            ...
            result = normalizeVNode(render2.length > 1 ? render2(("TURBOPACK compile-time truthy", 1) ? reactivity.shallowReadonly(props) : "TURBOPACK unreachable", ("TURBOPACK compile-time truthy", 1) ? {
                get attrs () {
                    markAttrsAccessed();
                ...
                slots,
                emit
            } : "TURBOPACK unreachable") : render2(("TURBOPACK compile-time truthy", 1) ? reactivity.shallowReadonly(props) : "TURBOPACK unreachable", null));
...
function initCustomFormatter() {
    ...
    ;
    const vueStyle = undefined;
    const numberStyle = undefined;
    const stringStyle = undefined;
    const keywordStyle = undefined;
...
//# sourceMappingURL=7dee8_%40vue_runtime-core_dist_runtime-core_cjs_90fde210.js.map